...
urlpatterns = [
    ...
    path('admin-add-fee/<str:cl>', views.admin_add_fee_view, name='admin-add-fee'),
    ...
    path('student-fee', views.student_fee_view,name='student-fee'),
    path('download-fee-challan', views.download_fee_challan, name='download-fee-challan'),
